"""
utils.py — Shared data loaders for the Queens Collision Dashboard.

Imported by page files instead of main.py to avoid circular execution.
All loaders are cached — load_data() is process-scoped, load_train_meta()
refreshes hourly from the inference API.
"""
